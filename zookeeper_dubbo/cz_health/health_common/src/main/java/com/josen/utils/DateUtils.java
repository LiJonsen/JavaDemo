...
//         HH:mm:ss
     ...
     * @throws Exception 抛出异常
     */
    public static String parseDateTime2String(Date date) {
        if (date == null) {
            return null;
        }
     ...
     * @return
     */
    public static String getLastDayOfMonth(String yearMonth) throws NumberFormatException {
    ...
    /**
     * 获取"2020-05-09"中的日期"09"
     * @param simpleDate
     * @return
     */
    public static String getDayForDate(String simpleDate){
        String str = simpleDate.substring(simpleDate.lastIndexOf("-") + 1, simpleDate.length());
        return str;
    }
}
